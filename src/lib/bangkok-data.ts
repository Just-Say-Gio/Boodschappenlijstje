...
export const DAYS: Day[] = [
  {
    ...
    emoji: "✈️",
    label: "Arrival Day",
    locked: "🌙 19:00 Jodd Fairs Night Market — vlak bij hotel, neon vibes + cocktails",
    slots: [
      {
        ...
        options: [
          {
            ...
            desc: "Sky Bar (Lebua/Hangover II), Octave of Vertigo. Welkomstdrankje met skyline view",
            type: "nightlife",
            dur: "1.5h",
            cost: "฿800pp",
            vibe: "Skyline views",
          },
          {
            ...
            desc: "Late food walk: Thip Samai, T&K Seafood, mango sticky rice (open tot 02:00)",
            type: "food",
            dur: "2h",
            cost: "฿500pp",
